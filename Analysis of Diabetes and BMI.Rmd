...
\section*{Model}
Now we need to build a logistic model to predict the result of \textit{Outcome}, which is whether an observation is having diabetes or not. 
...
propensity_score_regression <- 
  glm(Outcome ~ Pregnancies + Glucose + Insulin + SkinThickness +DiabetesPedigreeFunction + Age + BMI_num,
      data = data_matched)
...
```{r, echo=FALSE}
dt1 <- c("(Intercept)","Pregnancies", "Glucose" , "BloodPressure" , "SkinThickness" , "Insulin", "DiabetesPedigreeFunction", "Age", "BMI_num")

dt2 <- c("-0.192866" , "0.058395" , "0.001185", "0.005582" , "0.005710", "0.005582", "-0.402789", "0.005358", "-0.063085")
